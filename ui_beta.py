...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.frame.setGeometry(QtCore.QRect(10, 150, 761, 101))
        self.frame.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame.setObjectName("frame")
        self.audioviz = QtWidgets.QWidget(self.frame)
        self.audioviz.setGeometry(QtCore.QRect(10, 10, 741, 81))
        ...
        self.audioviz.setPalette(palette)
        self.audioviz.setAutoFillBackground(True)
        self.audioviz.setObjectName("audioviz")
        self.frame_2 = QtWidgets.QFrame(self.centralwidget)
        self.frame_2.setGeometry(QtCore.QRect(10, 260, 371, 281))
        ...
        self.timeBegin = QtWidgets.QTimeEdit(self.frame_2)
        self.timeBegin.setGeometry(QtCore.QRect(120, 80, 118, 24))
        ...
        self.frame_3.setGeometry(QtCore.QRect(400, 260, 371, 281))
        ...
        self.zoomInButton.setGeometry(QtCore.QRect(60, 100, 41, 41))
        ...
        self.zoomOutButton.setGeometry(QtCore.QRect(10, 100, 41, 41))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.loadFileButton.setGeometry(QtCore.QRect(260, 10, 281, 41))
        self.loadFileButton.setMinimumSize(QtCore.QSize(281, 0))
        self.loadFileButton.setObjectName("loadFileButton")
        self.currentFileName = QtWidgets.QLineEdit(self.centralwidget)
        self.currentFileName.setGeometry(QtCore.QRect(120, 50, 551, 21))
        ...
        self.lfile.setGeometry(QtCore.QRect(10, 50, 111, 21))
